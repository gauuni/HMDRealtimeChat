...
extension UIImageView {
    ...
    func display(urlString: String, placeholderImage: UIImage = #imageLiteral(resourceName: "ic_Player_Thumb"), completion: SDExternalCompletionBlock?=nil){
        let url = URL.init(string: urlString)
        self.sd_setImage(with: url, placeholderImage: placeholderImage, options: .highPriority, completed: completion)
    }
}
